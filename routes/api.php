...
Route::get('/skills/list',[SkillsController::class, 'apilist']);


Route::get('/project/list',[ProjectsController::class,'apilist']);


Route::get('/types/list',[TypesController::class,'apilist']);